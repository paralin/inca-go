...
func (*BlockState) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_99bc350a7543dec1, []int{0}
}
...
func (*TransactionSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_99bc350a7543dec1, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/inca-go/utils/transaction/transaction.proto", fileDescriptor_transaction_99bc350a7543dec1)
}

var fileDescriptor_transaction_99bc350a7543dec1 = []byte{
