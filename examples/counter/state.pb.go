...
It is generated from these files:
	github.com/aperturerobotics/inca-go/examples/counter/state.proto
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/inca-go/examples/counter/state.proto", fileDescriptor0)
}
