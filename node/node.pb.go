...
func (*NodeState) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_b5744aa65874a916, []int{0}
}
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/inca-go/node/node.proto", fileDescriptor_node_b5744aa65874a916)
}

var fileDescriptor_node_b5744aa65874a916 = []byte{
